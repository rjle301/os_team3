...
**
** @brief	Print byte offsets for fields in various structures.
**
** Based on   SCCS ID:	@(#)Offsets.c	2.2	1/23/25
**
...
int main( int argc, char *argv[] ) {
    ...
    */
	...
	// example, for a process context save area type:
